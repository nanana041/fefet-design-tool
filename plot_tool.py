...
#   (261은 앞선 251에서 3칸만 바뀐 판이다: 10–15 #1c4f7e→#194771, 20–25 #0070c0→
#    #2a79c0, 30–35 #80c262→#6db94b. 나머지 5칸과 >50 삼각형은 그대로.)
LOSS_BANDS = ["#194771", "#215f9a", "#2a79c0", "#3d9987",
              "#6db94b", "#b2d729", "#feda02", "#f8b342"]
LOSS_OVER = "#e25d4f"      # > 50 % (컬러바 위쪽 삼각형)
